...
def define_basic_flags():
  ...
  flags.DEFINE_enum('method', 'ieg', ['ieg', 'l2r', 'supervised', 'fsr', 'opt'],
                    'Method to deploy.')
  ...
  flags.DEFINE_bool('clean_opt', False, 'If true, the extract_labels are clean for optmization')
  flags.DEFINE_integer('opt_start_epoch', 32, 'Start epoch of opt epoch')
